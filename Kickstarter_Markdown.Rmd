...
#Currency
Currency of the country where the project will be developed.  There is a strong correlation between Currentcy and Country; so we will omit this feature during our analysis.
#Dead Line
...
Currency has a strong correlation with Country.  We won't need to use currency as country is more descriptive for our model.
