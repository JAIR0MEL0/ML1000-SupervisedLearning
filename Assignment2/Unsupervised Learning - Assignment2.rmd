...
##First step : 
Detect missing values and remove rows with missing values
```{r}
...
----------------Data exploration (looking at the big picture)------------------
...
To get this indication let us look at Fraction of failed and successful projects in each bin of each predictor.
...
Clearly, the success rate increases with the number of backers. Success rate is ~ 90% for projects with backers>200. The proportionality is linear (and very steep) from 0 to 40 backers. Beyond 40, the proporationality is linear but not as steep. This suggests that obtaining more backers beyond 40 might not pay off proportionatly in terms of higher success rate.
...
##Conclusion :
Backers and goal clearly have a high predicive power. The other 3 predictors (campaign, main_Category and country) have relatively low predictive power. However we will retain these 3 since we do not know how these interact with backers and goal as predictors.
...
##                 MeanDecreaseGini
backers             14023.1774
usd_goal_real        3488.0709
main_category        1132.2302
campaign              928.0397
country               245.2271
currency              155.9449

This is consistent with the conclusion we reached by inspecting the distributions. Since currency and country give similar information and importance of currency is quite low we elimate this feature.
